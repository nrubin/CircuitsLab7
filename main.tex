...
\caption{Plot of \Idm as a function of \Vdm for three values of \Vtwo, as well as lines representing \gdm. The slopes in the linear regions change fairly drastically with \Vtwo}
\label{fig:gdm}
\end{figure}
...
As is visually obvious in figure \ref{fig:gdm}
